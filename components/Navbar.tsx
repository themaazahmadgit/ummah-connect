          ...
          {!loading && profile ? (
            <div ref={menuRef} style={{ position: "relative" }}>
              <button
                ...
                style={{ display: "flex", alignItems: "center", gap: 8, background: "none", border: "none", cursor: "pointer", padding: "4px 8px", borderRadius: 8, transition: "background 0.1s" }}
              ...
              {menuOpen && (
                <div style={{
                  ...
                  overflow: "hidden", zIndex: 60, boxShadow: "0 8px 24px rgba(0,0,0,0.09)",
